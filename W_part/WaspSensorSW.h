...
class WaspSensorSW
{
	public:
		//! Class constructor
		WaspSensorSW();		//! Turns ON the board
		void ON(void);		//! Turns OFF the board
		void OFF(void);
...
class conductivityClass
{
	public:
		...
		void setCalibrationPoints(float _point_1_conductivity,
					  float _point_1_calibration,
					  float _point_2_conductivity,
					  float _point_2_calibration);
	private:
